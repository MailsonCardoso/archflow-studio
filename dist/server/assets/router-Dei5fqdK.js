...
const appCss = "/assets/styles-ASi4MUtr.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium uppercase tracking-[0.3em] text-primary", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-3 font-display text-4xl font-semibold text-foreground", children: "Página não encontrada" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "A rota que você tentou acessar não existe no ArchFlow." }),
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground", children: "Algo deu errado" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Tente novamente em instantes ou volte para a página inicial." }),
    ...
    handlers: {
      GET: async () => {
        const entries = [
          ...
          { path: "/editor", changefreq: "weekly", priority: "0.7" },
...
const $$splitComponentImporter$4 = () => import("./projects-Ca78zE7J.js");
const Route$4 = createFileRoute("/projects")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Gerencie todos os seus projetos arquitetônicos."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./profile-BMFOMAvp.js");
const Route$3 = createFileRoute("/profile")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Seu perfil e configurações no ArchFlow."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./editor-Dj53TwI6.js");
const Route$2 = createFileRoute("/editor")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Editor 2D/3D de plantas e ambientes."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./dashboard-CihrPKsR.js");
const Route$1 = createFileRoute("/dashboard")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Visão geral dos seus projetos no ArchFlow."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-MLC8_QWb.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Crie plantas 2D, visualize ambientes em 3D e gerencie projetos arquitetônicos em uma plataforma moderna e elegante."
    }, {
      property: "og:title",
      content: "ArchFlow"
    }, {
      property: "og:description",
      content: "Plantas 2D, visualização 3D e design de interiores em um único fluxo."
    }]
  }),
